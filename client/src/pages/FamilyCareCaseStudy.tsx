...
export default function FamilyCareCaseStudy() {
  const caseStudyData = {
    ...
    testimonial: {
      quote: "Clinexa Digital transformed our digital presence and streamlined our patient communication. The integration with our EMR system works flawlessly, and both our staff and patients love how easy the system is to use. Most importantly, we have complete confidence in the security and compliance of the solution.",
