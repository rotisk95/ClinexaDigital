...
import medicalIcon3 from "/src/assets/medical-icon3.svg";
import healthcareTech from "/src/assets/healthcare-tech.svg";
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 md:pr-12">
            ...
            <p className="text-lg text-gray-600 mb-6">
              ...
              and small medical practices.
            </p>
            <p className="text-lg text-gray-600 mb-6">
              Founded by healthcare and technology professionals, we understand
              the challenges medical practices face in the digital landscape.
              Our mission is to help healthcare providers leverage technology to
              improve patient trust and practice efficiency.
            </p>
            <p className="text-lg text-gray-600 mb-8">
              We pride ourselves on creating HIPAA-compliant, patient-friendly
              websites and digital tools that enhance the patient experience
              while streamlining your clinic operations. From appointment
              integration to digital forms, we build solutions designed for
              modern healthcare.
            </p>
